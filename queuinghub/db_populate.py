...
place4 = Place(name="Bar3", capacity=50, people_count=30, place_type="Bar", location="City2")
place5 = Place(name="Club2", capacity=200, people_count=120, place_type="Club", location="City2")
...
queue4 = Queue(queue_type="General", people_count=200, place=place2)
...
db.session.add_all([place1, place2, place3, place4, place5, queue1, queue2, queue3, queue4, user1, user2, user3])
db.session.commit()
ctx.pop()
